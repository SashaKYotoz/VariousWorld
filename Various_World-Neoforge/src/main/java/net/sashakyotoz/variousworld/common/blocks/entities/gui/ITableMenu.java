...
public abstract class ITableMenu extends AbstractContainerMenu {
    ...
    public ITableMenu(MenuType<?> menuType, int containerId) {
    ...
    public  <T extends BlockEntity> T findBlockEntity(Player player, Class<T> type) {
        Level level = player.level();
        float reach = (float) (1.0D + player.getAttributes().getValue(Attributes.BLOCK_INTERACTION_RANGE));
