...
public class SquealingSpiderEntity extends Spider {
    ...
    protected void customServerAiStep() {
        this.level().getProfiler().push("spiderBrain");
        this.getBrain().tick((ServerLevel) this.level(), this);
        this.level().getProfiler().popPush("spiderActivityUpdate");
    ...
    public static boolean checkSquealingSpiderSpawnRules(EntityType<SquealingSpiderEntity> spider, LevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
