...
public class DisassemblyTableBlockEntityRenderer extends IBlockEntityRenderer<DisassemblyTableBlockEntity> {
    ...
    @Override
    public void render(DisassemblyTableBlockEntity entity, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay, Vec3 vec3) {
