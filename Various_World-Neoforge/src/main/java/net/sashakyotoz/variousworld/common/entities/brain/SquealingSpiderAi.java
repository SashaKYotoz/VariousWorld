...
public class SquealingSpiderAi {
    ...
    private static void initIdleActivity(Brain<SquealingSpiderEntity> brain) {
        brain.addActivity(Activity.IDLE, ImmutableList.of(
                Pair.of(0, StartAttacking.create((mob) -> mob.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE))),
                Pair.of(1, StartAttacking.create(SquealingSpiderEntity::getHurtBy)),
                Pair.of(2, new SquealingSpiderAi.SlideToTargetSink(20, 40)),
    ...
    private static void initFightActivity(SquealingSpiderEntity entity, Brain<SquealingSpiderEntity> brain) {
        brain.addActivityWithConditions(Activity.FIGHT, ImmutableList.of(Pair.of(0,
                                StopAttackingIfTargetInvalid.create((living) -> !Sensor.isEntityAttackable(entity, living))),
