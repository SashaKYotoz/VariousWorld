...
public class ModelLordFuryTop<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("various_world", "modellord_fury_top"), "main");
	...
	public ModelLordFuryTop(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.0F)).texOffs(0, 0).mirror().addBox(-5.0F, -10.0F, -5.25F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.001F)).mirror(false)
						.texOffs(0, 0).addBox(3.0F, -10.0F, -5.25F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.001F)).texOffs(0, 4).mirror().addBox(-6.0F, -8.0F, -5.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).mirror(false).texOffs(0, 4).mirror()
						.addBox(5.0F, -8.0F, -5.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.001F)).mirror(false),
