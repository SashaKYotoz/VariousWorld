...
public class ModelFuryLord<T extends FuryLordEntity> extends HierarchicalModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("various_world", "model_fury_lord"), "main");
	...
	public ModelFuryLord(ModelPart root) {
		this.root = root;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(44, 28).addBox(-7.0F, -9.6F, 12.75F, 14.0F, 14.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -12.0F, -8.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(44, 28).addBox(-7.0F, -7.35F, -1.25F, 14.0F, 14.0F, 16.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -12.0F, -8.0F, 0.0873F, 0.0F, 0.0F));

		PartDefinition wingRight = generic.addOrReplaceChild("wingRight", CubeListBuilder.create(), PartPose.offset(-7.0F, 0.0F, -3.0F));

		PartDefinition cube_r6 = wingRight.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(-19, 104).mirror().addBox(-31.0F, -1.0F, 3.0F, 32.0F, 0.0F, 24.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.2618F, -0.1658F));

		PartDefinition cube_r7 = wingRight.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(70, 107).addBox(-31.0F, -4.0F, -3.0F, 32.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.2618F, -0.1745F));
		...
		PartDefinition cube_r8 = wingRightBone.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(49, 34).addBox(-3.0F, 3.0F, 5.0F, 3.0F, 2.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.1745F, -0.1745F));

		PartDefinition cube_r9 = wingRightBone.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(137, 100).addBox(-32.0F, 4.0F, 5.0F, 32.0F, 0.0F, 28.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r10 = wingLeft.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(-19, 104).addBox(-1.0F, -1.0F, 3.0F, 32.0F, 0.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, -0.2618F, 0.1833F));

		PartDefinition cube_r11 = wingLeft.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(70, 107).addBox(-1.0F, -4.0F, -3.0F, 32.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, -0.2618F, 0.1745F));
		...
		PartDefinition cube_r12 = wingLeftBone.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(49, 34).mirror().addBox(-3.0F, 4.0F, 5.0F, 3.0F, 2.0F, 22.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, -0.1745F, 0.1745F));

		PartDefinition cube_r13 = wingLeftBone.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(137, 100).mirror().addBox(0.0F, 5.0F, 5.0F, 32.0F, 0.0F, 28.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r14 = forwardLeftLeg.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(72, 0).mirror().addBox(-1.0F, 17.0F, -10.0F, 6.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, -1.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition cube_r15 = forwardLeftLeg.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(128, 24).addBox(-1.0F, 10.0F, -6.0F, 6.0F, 12.0F, 8.0F, new CubeDeformation(-1.0F))
		...
		PartDefinition cube_r16 = forwardRightLeg.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(72, 0).addBox(-19.0F, 17.0F, -10.0F, 6.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition cube_r17 = forwardRightLeg.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(128, 24).mirror().addBox(-5.0F, 10.0F, -6.0F, 6.0F, 12.0F, 8.0F, new CubeDeformation(-1.0F)).mirror(false)
		...
		PartDefinition cube_r18 = rearRightLeg.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(72, 0).addBox(-19.0F, 22.932F, -17.5405F, 6.0F, 3.0F, 11.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(14.0F, -5.932F, 12.5405F, 0.0F, 0.0F, 0.0436F));

		PartDefinition cube_r19 = rearRightLeg.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(99, 23).addBox(-5.0F, 14.932F, -13.5405F, 6.0F, 13.0F, 8.0F, new CubeDeformation(-1.0F))
		...
		PartDefinition cube_r20 = rearLeftLeg.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(99, 23).mirror().addBox(-1.0F, 10.0F, -6.0F, 6.0F, 13.0F, 8.0F, new CubeDeformation(-1.0F)).mirror(false)
		...
		PartDefinition cube_r21 = rearLeftLeg.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(72, 0).mirror().addBox(-1.0F, 18.0F, -10.0F, 6.0F, 3.0F, 11.0F, new CubeDeformation(0.15F)).mirror(false), PartPose.offsetAndRotation(0.0F, -1.0F, 5.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition tail = generic.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offset(0.0F, 5.0F, 21.0F));

		PartDefinition cube_r22 = tail.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(158, 15).addBox(-4.5F, -3.5F, 0.0F, 8.0F, 8.0F, 10.0F, new CubeDeformation(1.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 0.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r23 = tail.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(185, 33).mirror().addBox(-2.0F, -5.0F, -3.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -3.0F, 4.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition tail2 = tail.addOrReplaceChild("tail2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 7.0F));

		PartDefinition cube_r24 = tail2.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(185, 33).mirror().addBox(-2.0F, -5.0F, -3.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r25 = tail3.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(203, 45).addBox(-1.5F, -5.75F, -2.0F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r26 = tail4.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(192, 54).addBox(-1.5F, -5.5F, 1.0F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r27 = tail5.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(190, 44).mirror().addBox(-1.5F, -5.75F, 0.5F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r28 = tail6.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(232, 12).addBox(-7.0F, -0.75F, 0.25F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.5F)), PartPose.offsetAndRotation(0.0F, -6.0F, 17.0F, 0.1309F, 0.1745F, 0.0F));

		PartDefinition cube_r29 = tail6.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(185, 44).mirror().addBox(-1.5F, -3.75F, 1.25F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -6.0F, 17.5F, 0.1309F, 0.0F, 0.0F));

		PartDefinition cube_r30 = tail6.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(232, 12).addBox(0.0F, -0.75F, 0.25F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.5F)), PartPose.offsetAndRotation(0.0F, -6.0F, 17.0F, 0.1309F, -0.1745F, 0.0F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(entity.flyAnimationState, LordOfFuryAnimations.FLY, ageInTicks);
		this.animate(entity.idleInAirAnimationState, LordOfFuryAnimations.IDLEINAIR, ageInTicks);
		this.animate(entity.windAttackAnimationState, LordOfFuryAnimations.WIND_CURRENT_ATTACK, ageInTicks);
		this.animate(entity.tailAttackAnimationState, LordOfFuryAnimations.TAILATTACK, ageInTicks);
		this.animate(entity.summonAbilityAnimationState, LordOfFuryAnimations.SUMMON_OF_FURIES, ageInTicks);
