...
public class DisenchantTableBlockEntityRenderer implements BlockEntityRenderer<DisenchantTableBlockEntity> {
    public DisenchantTableBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }
    @Override
    public void render(DisenchantTableBlockEntity entity, float pPartialTick, PoseStack poseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
