...
public class DisenchantTableBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public DisenchantTableBlockEntity(BlockPos position, BlockState state) {
		super(VWBlockEntities.DISENCHANT_TABLE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("disenchant_table");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new DisenchantTableGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
