...
public class VWItems {
    ...
    public static final DeferredItem<SignItem> CRYSTALIC_OAK_SIGN = VWRegistryHelper.ofItem("crystalic_oak_sign", () -> new SignItem(VWBlocks.CRYSTALIC_OAK_SIGN.get(), VWBlocks.CRYSTALIC_OAK_WALL_SIGN.get(), new Item.Properties())).model().build();
    ...
    public static final DeferredItem<SignItem> BLUE_JACARANDA_SIGN = VWRegistryHelper.ofItem("blue_jacaranda_sign", () -> new SignItem(VWBlocks.BLUE_JACARANDA_SIGN.get(), VWBlocks.BLUE_JACARANDA_WALL_SIGN.get(), new Item.Properties())).model().build();
    ...
    public static final DeferredItem<SpawnEggItem> CRYSTALIC_SLIME_SPAWN_EGG = VWRegistryHelper.ofItem("crystalic_slime_spawn_egg", () ->
            new SpawnEggItem(VWEntities.CRYSTALIC_SLIME.get(), new Item.Properties())).build();
    public static final DeferredItem<SpawnEggItem> WANDERING_ZOMBIE_SPAWN_EGG = VWRegistryHelper.ofItem("wandering_zombie_spawn_egg", () ->
            new SpawnEggItem(VWEntities.WANDERING_ZOMBIE.get(), new Item.Properties())).build();
}