...
public class VWBiomes {
	public static final ResourceKey<Biome> CRYSTALIC_FOREST = ResourceKey.create(Registries.BIOME,ResourceLocation.fromNamespaceAndPath(VariousWorld.MODID,"crystalicforest"));
	public static final ResourceKey<Biome> PEACEFUL_WASTELAND = ResourceKey.create(Registries.BIOME,ResourceLocation.fromNamespaceAndPath(VariousWorld.MODID,"peaceful_wasteland"));
	public static final ResourceKey<Biome> SCULK_VALLEY = ResourceKey.create(Registries.BIOME,ResourceLocation.fromNamespaceAndPath(VariousWorld.MODID,"sculk_valley"));
	public static final ResourceKey<Biome> SHINY_VALLEY = ResourceKey.create(Registries.BIOME,ResourceLocation.fromNamespaceAndPath(VariousWorld.MODID,"shiny_valley"));
	public static final ResourceKey<Biome> CAVERN_OF_DEEP = ResourceKey.create(Registries.BIOME,ResourceLocation.fromNamespaceAndPath(VariousWorld.MODID,"cavernof_deep"));
	public static final ResourceKey<Biome> CAVERNS_OF_MAGMA_GROWTH = ResourceKey.create(Registries.BIOME,ResourceLocation.fromNamespaceAndPath(VariousWorld.MODID,"caverns_of_magma_growth"));
	@SubscribeEvent
