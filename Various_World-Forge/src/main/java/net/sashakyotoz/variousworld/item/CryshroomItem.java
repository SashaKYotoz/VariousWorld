...
public class CryshroomItem extends ItemNameBlockItem {
    public CryshroomItem() {
        super(VWBlocks.CRYSHROOM_PLANT.get(), new Item.Properties().stacksTo(64).food((new FoodProperties.Builder()).nutrition(2).saturationMod(0.5f).build()));
    }
    ...
    public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
        ...
        if (!entity.level().isClientSide()) {
            if (entity.getRandom().nextBoolean())
                entity.addEffect(new MobEffectInstance(VWMiscRegistries.AMETHYST_SPIKES.get(), 180, 1, true, false));
