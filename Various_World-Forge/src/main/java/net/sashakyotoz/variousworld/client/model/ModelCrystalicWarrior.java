...
public class ModelCrystalicWarrior<T extends CrystalWarriorEntity> extends HierarchicalModel<T> {
	...
	public ModelCrystalicWarrior(ModelPart root) {
		this.root = root;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-5.5F, -12.5F, -5.0F, 11.0F, 12.0F, 11.0F, new CubeDeformation(-1.0F)).mirror(false)
				.texOffs(84, 0).mirror().addBox(-5.5F, -12.5F, -5.0F, 11.0F, 12.0F, 11.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offset(0.0F, -5.0F, 0.0F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(2, 40).mirror().addBox(-9.0F, -7.0F, -4.5F, 18.0F, 13.0F, 10.0F, new CubeDeformation(-0.25F)).mirror(false)
				.texOffs(96, 103).mirror().addBox(4.5F, -7.0F, -5.5F, 4.0F, 13.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(96, 103).addBox(-8.5F, -7.0F, -5.5F, 4.0F, 13.0F, 12.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r1 = arm0.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(104, 73).mirror().addBox(0.0F, -3.0F, -4.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.25F)).mirror(false)
				.texOffs(104, 85).addBox(0.0F, -3.0F, -4.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(1.0F, 2.0F, 0.5F, 0.0F, 0.0F, -0.6109F));

		PartDefinition cube_r2 = arm0.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(104, 85).addBox(-1.0F, 0.0F, -4.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.0F, 0.5F, 0.0F, 0.0F, -0.0873F));

		PartDefinition cube_r3 = arm0.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(106, 25).addBox(-1.0F, 16.0F, -3.5F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.25F))
				.texOffs(0, 81).addBox(0.0F, -1.5F, -3.5F, 4.0F, 21.0F, 6.0F, new CubeDeformation(0.15F))
		...
		PartDefinition cube_r4 = arm1.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(104, 73).addBox(-5.0F, -3.0F, -4.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.25F))
				.texOffs(104, 85).mirror().addBox(-5.0F, -3.0F, -4.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 2.0F, 0.5F, 0.0F, 0.0F, 0.6109F));

		PartDefinition cube_r5 = arm1.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(104, 85).mirror().addBox(-4.0F, 0.0F, -4.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 2.0F, 0.5F, 0.0F, 0.0F, 0.0873F));

		PartDefinition cube_r6 = arm1.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(106, 25).mirror().addBox(-4.0F, 16.0F, -3.5F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.25F)).mirror(false)
				.texOffs(0, 81).mirror().addBox(-4.0F, -1.5F, -3.5F, 4.0F, 21.0F, 6.0F, new CubeDeformation(0.15F)).mirror(false)
