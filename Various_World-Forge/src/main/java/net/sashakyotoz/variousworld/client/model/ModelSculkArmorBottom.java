...
public class ModelSculkArmorBottom<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("various_world", "model_sculk_armor_bottom"), "main");
	public final ModelPart Body;
	public final ModelPart RightLeg;
	public final ModelPart LeftLeg;

	public ModelSculkArmorBottom(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(20, 21).addBox(-2.25F, 3.25F, -2.75F, 5.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
