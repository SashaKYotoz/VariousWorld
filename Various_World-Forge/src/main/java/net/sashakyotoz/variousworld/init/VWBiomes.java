...
public class VWBiomes {
    ...
    public static final ResourceKey<Biome> SHINY_VALLEY = ResourceKey.create(Registries.BIOME, new ResourceLocation(VariousWorld.MODID, "shiny_valley"));
    public static final ResourceKey<Biome> CAVERN_OF_DEEP = ResourceKey.create(Registries.BIOME, new ResourceLocation(VariousWorld.MODID, "cavernof_deep"));
    public static final ResourceKey<Biome> CAVERNS_OF_MAGMA_GROWTH = ResourceKey.create(Registries.BIOME, new ResourceLocation(VariousWorld.MODID, "caverns_of_magma_growth"));
                ...
                if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
                    ...
                    if (VariousWorldConfig.GENERATE_PEACEFUL_WASTELAND.get()) {
                        parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(0.45f, 0.9f), Climate.Parameter.span(-0.125f, 0.65f), Climate.Parameter.span(0.2f, 0.7f), Climate.Parameter.span(-0.25f, 0.5f),
                                Climate.Parameter.point(0f), Climate.Parameter.span(-0.56f, 0.46f), 0), biomeRegistry.getHolderOrThrow(PEACEFUL_WASTELAND)));
                        parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(0.45f, 0.9f), Climate.Parameter.span(-0.125f, 0.65f), Climate.Parameter.span(0.2f, 0.7f), Climate.Parameter.span(-0.25f, 0.5f),
                                Climate.Parameter.point(1f), Climate.Parameter.span(-0.56f, 0.46f), 0), biomeRegistry.getHolderOrThrow(PEACEFUL_WASTELAND)));
                    }
                    ...
                    if (VariousWorldConfig.GENERATE_SHINY_VALLEY.get()) {
                        parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(0.35f, 0.95f), Climate.Parameter.span(0.35f, 0.95f), Climate.Parameter.span(-0.15f, 0.6f), Climate.Parameter.span(0.35f, 1f),
                                Climate.Parameter.point(0f), Climate.Parameter.span(-0.75f, 0.55f), 0), biomeRegistry.getHolderOrThrow(SHINY_VALLEY)));
                        parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(0.35f, 0.95f), Climate.Parameter.span(0.35f, 0.95f), Climate.Parameter.span(-0.15f, 0.6f), Climate.Parameter.span(0.35f, 1f),
                                Climate.Parameter.point(1f), Climate.Parameter.span(-0.75f, 0.55f), 0), biomeRegistry.getHolderOrThrow(SHINY_VALLEY)));
                    }
