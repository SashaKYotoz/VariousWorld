...
public class ArmorStationBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ArmorStationBlockEntity(BlockPos position, BlockState state) {
		super(VWBlockEntities.ARMOR_STATION_BLOCK.get(), position, state);
	}
	...
	public ItemStack getItemStackToShow(){
		if (this.getItem(1).isEmpty() && this.getItem(3).isEmpty())
			return ItemStack.EMPTY;
		else if (!this.getItem(1).isEmpty() && this.getItem(3).isEmpty())
