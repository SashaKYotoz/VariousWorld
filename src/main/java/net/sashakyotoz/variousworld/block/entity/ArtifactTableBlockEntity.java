...
public class ArtifactTableBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ArtifactTableBlockEntity(BlockPos position, BlockState state) {
		super(VariousWorldModBlockEntities.ARTIFACT_TABLE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("artifacttable");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ArchOfGemsMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
