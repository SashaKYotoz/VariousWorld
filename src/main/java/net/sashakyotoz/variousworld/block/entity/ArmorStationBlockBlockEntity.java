...
public class ArmorStationBlockBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(4, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ArmorStationBlockBlockEntity(BlockPos position, BlockState state) {
	...
	public Component getDefaultName() {
		return Component.literal("armor_station_block");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ArmorStationMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
