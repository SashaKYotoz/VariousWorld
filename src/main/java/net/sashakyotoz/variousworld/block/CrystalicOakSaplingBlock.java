...
public class CrystalicOakSaplingBlock extends SaplingBlock implements BonemealableBlock {
	public CrystalicOakSaplingBlock() {
		super(new CrystalicOakTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING).sound(SoundType.GRASS).instabreak().noCollission());
	}
	...
	public List<ItemStack> getDrops(BlockState blockState, LootParams.Builder builder) {
		ItemStack itemStack = new ItemStack(VariousWorldModBlocks.CRYSTALIC_OAK_SAPLING.get());
