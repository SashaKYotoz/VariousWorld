...
public class VariousWorldBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        VariousWorldModBlocks.BLOCKS.getEntries().stream()
                ...
                .forEach(blockRegistryObject -> dropSelf(blockRegistryObject.get()));
        this.add(VariousWorldModBlocks.DARKNIUM_ORE.get(),block->createFortureAppliedOreDrops(block, VariousWorldModItems.RAW_DARKNIUM_INGOT.get(), 1,3));
        this.add(VariousWorldModBlocks.DEEPSLATE_DARKNIUM_ORE.get(),block->createFortureAppliedOreDrops(block, VariousWorldModItems.RAW_DARKNIUM_INGOT.get(), 1,4));
        this.add(VariousWorldModBlocks.SCULK_GEM_ORE.get(),block->createFortureAppliedOreDrops(block, VariousWorldModItems.RAW_SCULK_GEM.get(), 1,4));
        this.add(VariousWorldModBlocks.DEEPSLATE_SCULK_GEM_ORE.get(),block->createFortureAppliedOreDrops(block, VariousWorldModItems.RAW_SCULK_GEM.get(), 1,5));
        this.dropSelf(VariousWorldModBlocks.LORD_FURY_SCALES_BLOCK.get());
        this.dropSelf(VariousWorldModBlocks.DARKNIUM_BLOCK.get());
        this.dropSelf(VariousWorldModBlocks.SCULK_GEM_BLOCK.get());
    }
