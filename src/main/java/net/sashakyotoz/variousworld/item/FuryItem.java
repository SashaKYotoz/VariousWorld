...
public abstract class FuryItem extends ArmorItem {
	public FuryItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends FuryItem {
		public Helmet() {
	...
	public static class Chestplate extends FuryItem {
		public Chestplate() {
	...
	public static class Leggings extends FuryItem {
		public Leggings() {
	...
	public static class Boots extends FuryItem {
		public Boots() {
