...
public abstract class FuryArmorItem extends ArmorItem {
	public FuryArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(VariousWorldModItems.FURY_SCALES.get()));
			}
	...
	public static class Helmet extends FuryArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "various_world:textures/entities/fury_armor.png";
		}
	}

	public static class Chestplate extends FuryArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends FuryArmorItem {
		public Leggings() {
	...
	public static class Boots extends FuryArmorItem {
		public Boots() {
