...
public class WanderingSpiritProjectileEntity extends AbstractArrow {
    ...
    public void tick() {
        ...
        if (this.level() instanceof ServerLevel level && this.tickCount % 5 == 0) {
            this.level().addParticle(VariousWorldModParticleTypes.WANDERING_SPIRIT_PROJECTILE_PARTICLE.get(), this.getX(),this.getY(), this.getZ(), 0, 0, 0);
    ...
    public static WanderingSpiritProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
        WanderingSpiritProjectileEntity projectile = new WanderingSpiritProjectileEntity(VariousWorldModEntities.WANDERING_SPIRIT_PROJECTILE.get(), entity, world);
    ...
    public static WanderingSpiritProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
        WanderingSpiritProjectileEntity projectile = new WanderingSpiritProjectileEntity(VariousWorldModEntities.WANDERING_SPIRIT_PROJECTILE.get(), entity, entity.level());
