...
public class WanderingSpiritSummonedOfSculksEntity extends Monster implements RangedAttackMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(9, new WanderingSpiritSummonedOfSculksEntity.WanderingSpiritAbility(this));
    }
    ...
    public static void init() {
        SpawnPlacements.register(VariousWorldModEntities.WANDERING_SPIRIT_SUMMONED_OF_SCULKS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WanderingSpiritSummonedOfSculksEntity::checkSpiritConditions);
    }
