...
public class ArmoredskeletonEntity extends Monster {
	...
	public ArmoredskeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(VariousWorldModEntities.ARMOREDSKELETON.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(VariousWorldModEntities.ARMOREDSKELETON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(VariousWorldModEntities.ARMOREDSKELETON.get(), 180);
	}
