...
public class ArmoredSkeletonEntity extends Monster {
    ...
    enum ArmorType {
        ...
        DARKNIUM(VariousWorldModItems.DARKNIUM_ARMOR_HELMET.get().getDefaultInstance(), VariousWorldModItems.DARKNIUM_ARMOR_CHESTPLATE.get().getDefaultInstance(), VariousWorldModItems.DARKNIUM_ARMOR_LEGGINGS.get().getDefaultInstance(), VariousWorldModItems.DARKNIUM_ARMOR_BOOTS.get().getDefaultInstance()),
        FURY(VariousWorldModItems.FURY_HELMET.get().getDefaultInstance(), VariousWorldModItems.FURY_CHESTPLATE.get().getDefaultInstance(), VariousWorldModItems.FURY_LEGGINGS.get().getDefaultInstance(), VariousWorldModItems.FURY_HELMET.get().getDefaultInstance()),
