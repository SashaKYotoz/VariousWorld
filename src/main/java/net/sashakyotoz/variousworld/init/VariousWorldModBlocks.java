...
public class VariousWorldModBlocks {
	...
	private static final BlockBehaviour.Properties BLACKLY_MAGMA_PROPERTIES =BlockBehaviour.Properties.of().sound(VariousWorldModSounds.STONY_MAGMA).strength(5f).requiresCorrectToolForDrops();
	...
	public static final RegistryObject<Block> SAKURA_WALL_SIGN = BLOCKS.register("sakura_wall_sign", () -> new ModWallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), ModWoodType.MAGNOLIA));
	...
	public static final RegistryObject<Block> SCULK_WALL_SIGN = BLOCKS.register("sculk_wall_sign", () -> new ModWallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), ModWoodType.SCULK));
	...
	public static final RegistryObject<Block> CRYSTALIC_OAK_WALL_SIGN = BLOCKS.register("crystalic_oak_wall_sign", () -> new ModWallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), ModWoodType.CRYSTALIC_OAK));
