...
public class VariousWorldModItems {
	...
	public static final RegistryObject<Item> SCULK_BRIKS_SLAB = block(VariousWorldModBlocks.SCULK_BRICKS_SLAB);
	public static final RegistryObject<Item> SCULK_BRICKS_FENCE = block(VariousWorldModBlocks.SCULK_BRICKS_WALL);
	...
	public static final RegistryObject<Item> CRYSTAL_OF_CHANGED_BLOCK = block(VariousWorldModBlocks.CRYSTAL_OF_CHARGED_BLOCK);
	...
	public static final RegistryObject<Item> CRYSTALIC_OAK_SIGN = ITEMS.register("crystalic_oak_sign",()->new SignItem(new Item.Properties(),VariousWorldModBlocks.CRYSTALIC_OAK_SIGN.get(),VariousWorldModBlocks.CRYSTALIC_OAK_WALL_SIGN.get()));
	public static final RegistryObject<Item> SAKURA_SIGN = ITEMS.register("sakura_sign",()->new SignItem(new Item.Properties(),VariousWorldModBlocks.SAKURA_SIGN.get(),VariousWorldModBlocks.SAKURA_WALL_SIGN.get()));
	public static final RegistryObject<Item> SCULK_SIGN = ITEMS.register("sculk_sign",()->new SignItem(new Item.Properties(),VariousWorldModBlocks.SCULK_SIGN.get(),VariousWorldModBlocks.SCULK_WALL_SIGN.get()));
