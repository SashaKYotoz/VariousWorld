...
import net.sashakyotoz.variousworld.entity.animations.WanderingSpiritOfSculkAnimations;

public class ModelWanderingSpirit<T extends WanderingSpiritOfSculksEntity> extends HierarchicalModel<T> {
    ...
    public ModelWanderingSpirit(ModelPart root) {
        this.root = root;
