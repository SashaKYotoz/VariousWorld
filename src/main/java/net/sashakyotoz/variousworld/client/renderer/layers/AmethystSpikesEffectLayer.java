...
public class AmethystSpikesEffectLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    private final ModelAmethystSpikes<T> armorModel;

    public AmethystSpikesEffectLayer(RenderLayerParent<T, M> p_174493_, EntityModelSet p_174494_) {
        super(p_174493_);
        this.armorModel = new ModelAmethystSpikes<>(p_174494_.bakeLayer(ModelAmethystSpikes.LAYER_LOCATION));
    }
    ...
    public boolean shouldRender(ItemStack stack, T entity) {
        return entity.hasEffect(VariousWorldModMobEffects.AMETHYST_SPIKES.get());
    }

    public ResourceLocation getRodsLocation(ItemStack stack, T entity) {
        return AMETHYSTS_LOCATION;
    }
}
