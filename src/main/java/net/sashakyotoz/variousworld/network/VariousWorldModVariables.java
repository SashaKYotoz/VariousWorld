...
public class VariousWorldModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		VariousWorldMod.addNetworkMessage(SavedDataSyncMessage.class, SavedDataSyncMessage::buffer, SavedDataSyncMessage::new, SavedDataSyncMessage::handler);
	...
	public static class EventBusVariableHandlers {
		...
		public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
			if (!event.getEntity().level().isClientSide()) {
				...
				if (mapdata != null)
					VariousWorldMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getEntity()), new SavedDataSyncMessage(0, mapdata));
				if (worlddata != null)
					VariousWorldMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getEntity()), new SavedDataSyncMessage(1, worlddata));
			}
		}
	...
	public static class WorldVariables extends SavedData {
		public static final String DATA_NAME = "various_world_worldvars";
	...
	public static class MapVariables extends SavedData {
		public static final String DATA_NAME = "various_world_mapvars";
		public double WitheredTime = 0.0;
		...
		public void read(CompoundTag nbt) {
			WitheredTime = nbt.getDouble("WitheredTime");
		}

		@Override
		public CompoundTag save(CompoundTag nbt) {
			nbt.putDouble("WitheredTime", WitheredTime);
			return nbt;
		}
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level && !world.isClientSide())
				VariousWorldMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new SavedDataSyncMessage(0, this));
		}
